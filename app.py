...
def index():
    if request.method == 'POST':
        ...
        if not text.strip():
            return render_template('index.html', error="Please provide text or upload a valid file.")
        ...
        if not mcqs:
            return render_template('index.html', error="Could not generate any MCQs. Try using different text.")
